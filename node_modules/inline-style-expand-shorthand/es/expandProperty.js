...
function parseGap(value) {
  ...
  var _splitShorthand3 = splitShorthand(value),
      ...
      columnGap = _splitShorthand4$ === void 0 ? rowGap : _splitShorthand4$; // This property is a shorthand that sets row-gap and column-gap in one declaration. If <'column-gap'> is omitted, it’s set to the same value as <'row-gap'>.
